...
class DeleteDishInput(BaseModel):
...
class DeleteDishOutput(BaseModel):
    deleted: bool


class DeleteDishWorkflow:
    def __init__(
        self,
    ...
    async def execute(self, input_data: DeleteDishInput) -> DeleteDishOutput:
        ...
        deleted = await self.dish_repository.delete(input_data.dish_id)
        return DeleteDishOutput(deleted=deleted)
